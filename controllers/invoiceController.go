...
func GetInvoices() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.JSON(http.StatusOK, gin.H{"data": allInvoices})
	}
}
...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		invoiceView.Order_details = invoice.Order_id
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "the order was not found"})
			return
		}
